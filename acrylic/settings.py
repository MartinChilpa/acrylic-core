...
MIDDLEWARE = [
    ...
    'account.middleware.AccountLanguageMiddleware',
...
REST_FRAMEWORK = {
    ...
    # JWT first: DRF builds the 401 WWW-Authenticate header from the first class
    # listed, and a Basic challenge makes browsers pop up their native login dialog.
